...
public class UserTests2 {
	...
	public void testUpdateUserByName() {
		...
		Response resposneAfterUpdate= UserEndPoints2.readUser(this.userPayload.getUsername());
	...
	public void testDeleteUserByName() {
		...
		Response resposneAfterDelete= UserEndPoints2.readUser(this.userPayload.getUsername());
